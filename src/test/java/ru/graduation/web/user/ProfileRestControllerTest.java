...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        USER_MATCHER.assertMatch(userService.getAll(), Arrays.asList(ADMIN, USER2, USER3, USER4));
    }
    ...
    void update() throws Exception {
        ...
        USER_MATCHER.assertMatch(userService.get(USER_ID1), UserUtil.updateFromTo(new User(USER1), updatedTo));
    }
